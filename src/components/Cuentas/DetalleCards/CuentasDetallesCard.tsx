...
import { CuentaFormType, propDetalleType } from '../types';
...
//import { validacionCuentaDetalle } from './validacionCuentaDetalle';


export const CuentasDetallesCard = ({id}:propDetalleType) => {
  ...
  const formik = useFormik({
    ...
    //validate: validacionCuentaDetalle,
  });

...
export const PerfilCard = () => {
  return (
    <CardTemplate name="FOTOGRAFÍA" classname="tw-w-full">
      <div className='flex justify-content-center align-items-center flex-column'>
        <img className='tw-rounded-full tw-mb-8' src={Plogo} alt="Profile Photo" />
        <p className='tw-text-sm tw-font-medium tw-text-gray-grayt tw-mb-6'>JPG o PNG no mayor a 1 MB</p>
